...
# do not attempt testing as it will fail on musl-libc
PATCHES=(
	"${FILESDIR}"/Makefile-no-test.patch
)
...
# force usage of our 1.1.7 patched cmocka version
DEPEND="
	${RDEPEND}
	elibc_glibc? (
...
multilib_src_configure() {
	...
	# ==========================================================
	# Note: Do not use bundled cmocka, force our patched version
	#       The bundled will not work with musl-libc
	# ==========================================================
	#######if ! use test ; then
